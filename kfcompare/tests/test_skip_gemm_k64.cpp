// test_skip_gemm_k64.cpp - Compare baseline vs KernelFaRer for skip_gemm_k64.cc
// Stride 64 on k dimension (requires A col major, B row major)
// Usage: ./test_skip_gemm_k64 [--size N | --size MxKxN] [--stress ITERS]
#include "KFCompare.h"
...
int main(int argc, char** argv) {
    ...
    return kfcompare::run<float>(cfg, "skip_gemm_k64 (striped_gemm)",
