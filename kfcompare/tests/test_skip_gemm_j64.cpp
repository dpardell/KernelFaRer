// test_skip_gemm_j64.cpp - Compare baseline vs KernelFaRer for skip_gemm_j64.cc
// Stride 64 on j dimension
// Usage: ./test_skip_gemm_j64 [--size N | --size MxKxN] [--stress ITERS]
#include "KFCompare.h"
...
int main(int argc, char** argv) {
    ...
    return kfcompare::run<float>(cfg, "skip_gemm_j64 (striped_gemm)",
