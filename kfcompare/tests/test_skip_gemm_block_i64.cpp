// test_skip_gemm_block_i64.cpp - Compare baseline vs KernelFaRer for skip_gemm_block_i64.cc
// Blocked GEMM with stride on i dimension
// Usage: ./test_skip_gemm_block_i64 [--size N | --size MxNxK] [--stress ITERS]
#include "KFCompare.h"
...
int main(int argc, char** argv) {
    ...
    return kfcompare::run<float>(cfg, "skip_gemm_block_i64 (striped_gemm)",
