// test_skip_gemm_k2.cpp - Compare baseline vs KernelFaRer for skip_gemm_k2.cc
// Stride 2 on k dimension (requires A col major, B row major)
// Usage: ./test_skip_gemm_k2 [--size N | --size MxKxN] [--stress ITERS]
#include "KFCompare.h"
...
int main(int argc, char** argv) {
    ...
    return kfcompare::run<float>(cfg, "skip_gemm_k2 (striped_gemm)",
